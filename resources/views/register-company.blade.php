            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('login') }}">
                    ...
                    <div
                        ...
                        <p class="lead fw-normal mb-0 me-3">Enviar Solicitud</p>
                    </div>
                    ...
                    <div class="form-outline mb-4 validate-input m-b-16" data-validate="Requiere ingresar el nombre de la empresa">
                        <input id="nombreEmpresa" type="text"
                            class="form-control form-control-lg @error('nombreEmpresa') is-invalid @enderror" name="nombreEmpresa"
                    ...
                    <div class="form-outline mb-3" validate-input m-b-16"
                        ...
                        <input id="ruc"
                            class="form-control  form-control-lg @error('ruc') is-invalid @enderror"
                    ...
                    <!-- Password input -->
                    <div class="form-outline mb-3" validate-input m-b-16"
                        data-validate="Requiere ingresar un ruc">
                        <input id="ruc"
                            class="form-control  form-control-lg @error('ruc') is-invalid @enderror"
                            type="text" name="ruc" placeholder="{{ __('RUC') }} " required>
                    ...
                    <div class="form-outline mb-3" validate-input m-b-16"
                        ...
                        <input id="correo"
                            ...
                            type="text" name="email" placeholder="{{ __('Correo') }} " value="{{ old('email') }}" required autocomplete="email">
                    ...
                    <div class="form-outline mb-3" validate-input m-b-16"
                        ...
                        <input id="direccion"
                            ...
                            type="text" name="direccion" placeholder="{{ __('Direccion') }} "  required autocomplete="direccion">
