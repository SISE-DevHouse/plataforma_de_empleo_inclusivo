        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('login') }}">
                    ...
                    @csrf<div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <div class="form-outline mb-4 validate-input m-b-16" data-validate="Requiere ingresar un Email">
                        <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{ __('Ingrese E-Mail') }}" autofocus>
                    ...
                    <div class="form-outline mb-3" validate-input m-b-16" data-validate="Requiere ingresar una contraseña">
                        <input id="password" class="form-control  form-control-lg @error('password') is-invalid @enderror" type="password" name="password" placeholder="{{ __('Password') }} " required autocomplete="current-password">
